...
{
    public class FindGenericVariable<T> where T : IComparable
    {
        public T A, B, C;
        public FindGenericVariable(T A, T B, T C)
        {
            this.A = A;
            this.B = B;
            this.C = C;
        ...
        public T MaxMethod()
        {
            T Max = FindGenericVariable<T>.MaxNumber(this.A, this.B, this.C);
            return Max;
